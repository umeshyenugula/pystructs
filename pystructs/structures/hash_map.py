...
class HashMap(Generic[K, Val]):
    ...
    def merge(self, key: K, value: Val, remapping_fn: Callable[[Val, Val], Val]) -> Val:
        """
    ...
    def compute_if_absent(self, key: K, mapping_fn: Callable[[K], Val]) -> Val:
    ...
    def to_list(self) -> list[tuple[K, Val]]:
...
class HashSet(Generic[K]):
    ...
    def add_all(self, items: Iterable[K]) -> None:
